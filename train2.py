...
train_path=r'C:\Users\Pro\Desktop\L3TDSI_2022\Memoire_l3tdsi\Projetl3TDSI\image1\train'
test_path=r'C:\Users\Pro\Desktop\L3TDSI_2022\Memoire_l3tdsi\Projetl3TDSI\image1\test'
...
fig[0].plot(train_accuracy_list, label='Train Accuracy')
fig[0].plot(test_accuracy_list, label='Test Accuracy')
fig[0].set_xlabel('Epoch')
fig[0].set_ylabel('Accuracy')
fig[0].legend()

fig[1].plot(train_loss_list, label='Train Loss')
